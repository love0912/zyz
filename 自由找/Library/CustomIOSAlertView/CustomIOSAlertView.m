...
- (void)show
{
    ...
    self.backgroundColor =[UIColor whiteColor]; //[UIColor colorWithRed:0 green:0 blue:0 alpha:0];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i==1) {
            [closeButton setTitleColor:[UIColor colorWithRed:255.0/255.0 green:123.0/255.0 blue:35.0/255.0 alpha:1.0f] forState:UIControlStateNormal];

        }else{
           [closeButton setTitleColor:[UIColor colorWithRed:153.0/255.0 green:153.0/255.0 blue:153.0/255.0 alpha:1.0f] forState:UIControlStateNormal];
        }
        [closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
        [closeButton.layer setCornerRadius:kCustomIOSAlertViewCornerRadius];
       
        [container addSubview:closeButton];
        for (int j=0; j<[buttonTitles count]-1; j++) {
            UILabel *lineLabel=[[UILabel alloc]init];
            [lineLabel setFrame:CGRectMake((j+1) * buttonWidth, container.bounds.size.height - buttonHeight+4, 1, buttonHeight-8)];

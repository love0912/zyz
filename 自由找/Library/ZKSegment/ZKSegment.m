...
- (void)commonInit {
    ...
    self.itemStyleSelectedColor = [UIColor orangeColor]; // ZK_UIColorFromRGBAlpha(202.0f, 51.0f, 54.0f, 1.0f);
    switch (self.segmentStyle) {
        case ZKSegmentLineStyle:
            self.zk_itemSelectedColor = [UIColor orangeColor];// ZK_UIColorFromRGBAlpha(202.0f, 51.0f, 54.0f, 1.0f);
            break;
    ...
    self.segmentBackgroundColor = [UIColor whiteColor]; // ZK_UIColorFromRGBAlpha(238.0f, 238.0f, 238.0f, 1.0f);

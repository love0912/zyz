...
//    UINavigationBar *_jx_navigationBar;
//}
//
...
//
//- (void)addToolbar {
//    _jx_navigationBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0, 0, ScreenSize.width, 64)];
//    _jx_navigationBar.barTintColor = [UIColor colorWithHex:@"EBEBEB"];
//    [_jx_navigationBar jj_setBackgroundColor:[CommonUtil zyzOrangeColor]];
//    [self.view addSubview:_jx_navigationBar];
//    UINavigationItem *item = [[UINavigationItem alloc] init];
//    _jx_navigationBar.items = @[item];
//    //添加返回按钮
...
//    }
//    _jx_navigationBar.items.firstObject.title=@"客服";
//    [_jx_navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName: [UIColor whiteColor]}];
//}
//
